...
export const ar: TranslationDict = {
  ...
  reports: {
    ...
    customerPaymentsCashIn: "مدفوعات العملاء المستلمة",
  ...
  auth: {
    ...
    passwordMinLength: "٦ أحرف على الأقل",
    signingIn: "جارٍ الدخول…",
    sendingRequest: "جارٍ الإرسال…",
    passwordMismatch: "كلمتا المرور غير متطابقتين.",
    emailInUse: "البريد الإلكتروني مستخدم مسبقاً.",
    weakPassword: "كلمة المرور يجب أن تحتوي على ٦ أحرف على الأقل.",
    noInternetRegister: "لا يوجد اتصال. تحتاج إلى الإنترنت للتسجيل.",
    registrationFailed: "فشل التسجيل. حاول مجدداً.",
    invalidCredentials: "البريد الإلكتروني أو كلمة المرور غير صحيحة.",
    tooManyAttempts: "محاولات كثيرة. حاول لاحقاً.",
    noInternetLogin: "لا اتصال. تحتاج الإنترنت لأول تسجيل دخول.",
    ...
    signOutStatPending: "وظيفة مزامنة معلقة",
    signOutStatConflicts: "تعارض",
    signOutStatPayments: "دفعة",
  ...
  shift: {
    ...
    cloudProducts: "المنتجات السحابية",
    netSales: "صافي المبيعات",
    customerDebt: "ديون العملاء",
    lowStock: "مخزون منخفض",
    outOfStock: "نفد من المخزون",
    generateResetLink: "إنشاء رابط إعادة تعيين كلمة المرور",
    deactivate: "تعطيل",
    ...
    cloudStats: "إحصائيات السحابة",
    noBackup: "لا يوجد نسخ احتياطي",
    neverSynced: "لم يتمت المزامنة أبدًا",
    billItems: "بنود الفواتير",
    movements: "حركات المخزون",
    payments: "مدفوعات العملاء",
    settingsUpdated: "تم تحديث الإعدادات",
    resetLinkGenerated: "تم نسخ رابط إعادة تعيين كلمة المرور إلى الحافظة.",
    resetLinkError: "فشل إنشاء رابط إعادة التعيين.",
    approvalSuccess: "تمت الموافقة على المستخدم.",
    rejectionSuccess: "تم رفض المستخدم.",
    deactivationSuccess: "تم تعطيل المستخدم.",
    reactivationSuccess: "تم إعادة تفعيل المستخدم.",
    totalUsers: "المستخدمين",
    pendingCount: "قيد الانتظار",
    activeCount: "نشط",
    needsHelp: "يحتاج مساعدة",
    supportChecklist: "قائمة دعم المراجعة",
    backupCounts: "أعداد النسخ الاحتياطي",
    noWarnings: "لم يتم العثور على تحذيرات دعم. النسخة الاحتياطية تبدو صحية.",
    activeProducts: "المنتجات النشطة",
    inactiveProducts: "المنتجات غير النشطة",
    voidedBills: "الفواتير الملغاة",
    returnedBills: "الفواتير المعادة",
    ...
    backToSupportDashboard: "العودة إلى لوحة تحكم الدعم",
    joined: "انضم في",
    healthyBackup: "نسخة احتياطية سليمة",
