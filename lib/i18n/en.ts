...
export const en: TranslationDict = {
  ...
  reports: {
    ...
    customerPaymentsCashIn: "Customer Payments Received",
  ...
  auth: {
    ...
    noInternetRegister: "No internet. You need to be online to register.",
    registrationFailed: "Registration failed. Please try again.",
    invalidCredentials: "Invalid email or password.",
    tooManyAttempts: "Too many attempts. Try again later.",
    noInternetLogin: "No internet. You must be online for first login.",
    ...
    signOutStatPending: "pending sync jobs",
    signOutStatConflicts: "conflicts",
    signOutStatPayments: "payments",
  ...
  purchases: {
    ...
    purchaseFailed: "Could not save purchase.",
    purchaseCompleted: "Purchase saved",
    openPurchaseDetail: "Open purchase",
    newPurchaseAction: "New purchase",
    historyTitle: "Purchase history",
    historySubtitle: "Saved purchase invoices.",
  ...
  suppliers: {
    ...
    supplierDetailsDesc: "Purchase invoice and payment history.",
    purchases: "Purchases",
    noPurchases: "No purchases for this supplier yet.",
    payments: "Payments",
    noPayments: "No payments recorded yet.",
    creditBalanceNote: "We owe",
    recordPayment: "Record payment",
    recordPaymentDesc: "Record a debt payment to {{name}}.",
    paymentAmount: "Payment amount",
    paymentMethod: "Payment method",
    note: "Note",
    notePlaceholder: "Example: cash payment, bank transfer, partial payment...",
  ...
  shift: {
    ...
    cashierName: "Cashier",
    cashierNameHelper: "Defaults to the cashier name set in Settings.",
    openShiftNotes: "Notes",
    openShiftNotesPlaceholder: "Optional. Example: morning shift, register #2.",
    ...
    paymentsInShift: "Supplier payments",
    billsInShift: "Bills",
    itemsInShift: "Items sold",
    voidedCount: "Voided",
    ...
    closeShiftFailed: "Could not close shift.",
  ...
  admin: {
    ...
    resetLinkGenerated: "Password reset link copied to clipboard.",
    resetLinkError: "Failed to generate reset link.",
    approvalSuccess: "User approved.",
    rejectionSuccess: "User rejected.",
    deactivationSuccess: "User deactivated.",
    reactivationSuccess: "User reactivated.",
    totalUsers: "Users",
    ...
    noWarnings: "No support warnings found. Backup looks healthy.",
    ...
    backToSupportDashboard: "Back to Support Dashboard",
    joined: "Joined",
    healthyBackup: "Healthy backup",
